...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_services_icon" AS ENUM('brain', 'code', 'palette', 'layout', 'megaphone', 'rocket', 'shield', 'zap', 'globe', 'smartphone');
  CREATE TYPE "public"."enum_services_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__services_v_version_icon" AS ENUM('brain', 'code', 'palette', 'layout', 'megaphone', 'rocket', 'shield', 'zap', 'globe', 'smartphone');
